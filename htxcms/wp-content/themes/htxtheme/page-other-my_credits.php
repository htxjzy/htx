...
$(function(){
	...
	$(".layui-main .layui-clear > .user-left > ul li:nth-child(2) dl dd:nth-child(4) a").addClass("active");
        ...
        <div class="user-right">
			...
			<div class="htx-box">
                <h3>
                    <b class="bc-red">我的信誉评价</b>
                    <a class="fr" href="#">我的信誉值如何计算？</a>
                </h3>
                <div class="credit-rating">
                    ...
                    <div class="f16 pt20 pb20 "><b>威客对我的综合评价</b></div>
                    <div class="layui-clear">
                        <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tablebor">
                            <tbody>
                            <tr class="bgf4">
                                <td align="center">平均好评率</td>
                                <td width="33%" height="38" align="center">付款及时性</td>
                                <td width="33%" align="center">合作愉快度</td>
                            </tr>
                            <tr>
