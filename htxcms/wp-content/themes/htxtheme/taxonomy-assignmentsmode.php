		...
		$(".all_region").hide(200);
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <th>任务状态 <br/> 距投标截止期</th>
                                    <th>我要操作</th>
                                </tr>
                                </thead>
                                <tbody>
<?php 
$cur_url = home_url().'/assignmentsmode/'.$cur_slug;
...
$args=array(
	...
	'paged' 	=> $paged,
	'tax_query' => array(array('taxonomy' => 'assignmentsmode', 'field'=>'slug', 'terms' =>$cur_slug))        
);
