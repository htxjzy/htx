...
<div class="page-submission">
	<div class="dyn-nav">
		<blockquote class="layui-elem-quote">当前位置 <i class="layui-icon" style="font-size:22px; margin:0 10px; color:#FF5722;">&#xe715;</i> <a href="/" title="返回首页">首页</a><i class="layui-icon" style="font-size:16px; margin:0 10px; color:#666;">&#xe602;</i><span>委托项目</span></blockquote>
    </div>
    <div class="page-submission-wrap layui-row layui-col-space30">
    
    	<div class="layui-col-md9">
			<div class="page-submission-content">
            	<h1>全托项目信息 <i class="layui-icon" style="font-size:28px; color:#FF5722; float:left;">&#xe609;</i></h1>
...
<script type="text/javascript" src="/p/js/submit_boarding_project.js?ver=1.0"></script>
            </div>               
        </div>
