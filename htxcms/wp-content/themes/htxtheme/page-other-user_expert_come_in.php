...
if(is_user_logged_in()){
	...
	$cur_expert = $wpdb->get_row("SELECT ID FROM htx_posts WHERE post_author='{$cur_user}' AND post_type='experts'");
...
if(!empty($_POST['like'])){
	...
	if( 0 !== wp_insert_post($exp_post)){
		echo '{"reg":"您好，专家设置已更新，审核过后即发布 <i class=\"layui-icon\" style=\"font-size:30px; color:#FF5722;\">&#xe60c;</i>"}';		
