...
if ( ! function_exists( 'cptch_display_captcha' ) ) {
	function cptch_display_captcha() {
		...
		foreach ( $operand_formats as $key => $format ) {
			switch ( $format ) {
				case 'input':
					$operand[] = '<input id="cptch_input" class="cptch_input" type="text" autocomplete="off" name="cptch_number" value="" maxlength="2" size="2" aria-required="true" required="required" style="margin-bottom:0;display:inline;font-size:18px;color:#212121;width: 40px;" />';
					break;
				case 'word':
